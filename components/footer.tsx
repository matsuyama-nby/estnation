				...
				<div className="other-content">
					...
					<div className="mx-[calc(26/390*100vw)] md:mx-[calc(120/1280*100vw)]">
							...
							<a href="" className="relative">
								<div className="link-ttl z-2">
									<picture className="flex justify-center">
										...
										<img src="/photo/page/creative_with_refine/01/img/vol-01.png" alt="" className="w-[calc(171/1280*100vw)] mb-[calc(31.56/1280*100vw)]" />
									</picture>
								...
								<picture>
									<source srcSet="/photo/page/creative_with_refine/01/img/img-other.webp" type="image/webp" />
									<img src="/photo/page/creative_with_refine/01/img/img-other.jpg" alt="" />
								</picture>
						...
						<div className="block md:hidden">
							<a href="" className="relative">
								<picture>
									<source srcSet="/photo/page/creative_with_refine/01/img/img-other-sp.webp" type="image/webp" />
									<img src="/photo/page/creative_with_refine/01/img/img-other-sp.jpg" alt="" />
								</picture>
							...
							<div className="text-[var(--color-secondary)] mt-[15px]">
								<picture>
									<source srcSet="/photo/page/creative_with_refine/01/img/vol-01.webp" type="image/webp" />
									<img src="/photo/page/creative_with_refine/01/img/vol-01.png" alt="" className="w-[159px] mb-[11.48px]" />
								</picture>
				...
				<ul className="md:flex-gap-none-2col">
					<li className="other-item">
						<a href="https://www.estnation.co.jp/store" className="relative">
							...
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-store.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-store.jpg" alt="" />
							</picture>
						</a>
					</li>
					<li className="other-item">
						<a href="https://www.estnation.co.jp/" className="relative">
							...
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-online.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-online.jpg" alt="" />
							</picture>
						</a>
					</li>					
				</ul>
