		...
		<main className="main-content">
			...
			<div className="kv-wrapper">
				<div className="relative">
					...
					<div className="kv-ttl-content z-2">
						<h1 className="font-en-garamond text-[calc(35/390*100vw)] md:text-[calc(45/1280*100vw)] tracking-[0.1em] leading-[1.09] md:leading-[1.4] mb-[calc(20/390*100vw)] md:mb-[calc(20/1280*100vw)]">
			...
			<section className="section">
				...
				<div className="hidden md:block">
					<div className="flex-gap-40-2col">
						...
						<div>
							<h2 className="section-ttl font-semibold">旅は新たな知識のカケラ<br />を与えてくれる</h2>
			...
			<section className="section">
				...
				<div className="hidden md:block">
					...
					<h2 className="section-ttl font-semibold">日本的な美意識を<br />現代の感覚に落とし込む</h2>
			...
			<section className="section">
				{/* pc */}
				<div className="hidden md:block">
					<h2 className="section-ttl font-semibold">着心地の良さを追求することは<br />楽さだけなく、自信にもつながる</h2>
			...
			<section className="section md:flex-gap-40-2col">
				<div>
					<h2 className="section-ttl font-semibold">好奇心を持ち続けることが<br />洗練につながる</h2>
			...
			<section className="section md:flex-gap-40-2col !pt-[15.5px] md:!pt-[19px] !pb-[60px] md:!pb-[80px]">
				<p className="font-en-futura text-[13px] tracking-[0.12em] leading-[1.31] font-medium">HOTEL</p>
			...
			<section className="section-hotel">
				...
				<p className="text-[15px] md:text-[18px] tracking-[0.02em] leading-[1.78] mb-[38.5px] md:mb-[36.5px] font-semibold">地方にある知性を刺激する宿たち</p>
