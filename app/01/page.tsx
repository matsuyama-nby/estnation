...
return (
	<div className={`${isReady ? "is-ready" : ""}`}>
		...
		<main className="main-content">
			...
			<div className="kv-wrapper">
				<div className="relative">
					...
					<picture className="hidden md:block">
						<source srcSet="/photo/page/creative_with_refine/01/img/img-kv.webp" type="image/webp" />
						<img src="/photo/page/creative_with_refine/01/img/img-kv.jpg" alt="THE INTELLECTUAL JOURNEY" />
					</picture>
					{/* sp */}
					<picture className="block md:hidden">
						<source srcSet="/photo/page/creative_with_refine/01/img/img-kv-sp.webp" type="image/webp" />
						<img src="/photo/page/creative_with_refine/01/img/img-kv-sp.jpg" alt="THE INTELLECTUAL JOURNEY" />
					</picture>
					...
					<div className="kv-ttl-content z-2">
						...
						<div className="flex mb-[calc(30/390*100vw)] md:mb-[calc(25/1280*100vw)]">
							<picture className="mx-auto">
								<source srcSet="/photo/page/creative_with_refine/01/img/vol-01.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/vol-01.png" alt="" className="w-[calc(159/390*100vw)] md:w-[calc(181/1280*100vw)]" />
							</picture>
						</div>
			...
			<div className="intro">
				<p className="font-en-futura text-[12px] md:text-[13px] tracking-[0.12em] leading-[1.31] font-medium">INTRODUCTION</p>
			...
			<section className="section !pt-[51px] md:!pt-[43px] pb-[60px] md:!pb-[70px]">
				...
				<div className="md:flex-gap-40-2col flex flex-col md:flex-row">
					<div className="order-2 md:order-1">
						<p className="font-en-futura text-[10px] md:text-[11px] tracking-[0.12em] leading-[1.3] md:leading-[1.27] mb-[10.5px] md:mb-[15px] text-center md:text-left">ALA CHAMP MAGAZINE FOUNDER</p>
						<p className="section-ttl-garamond-sm mb-[7px] md:mb-[8px] text-center md:text-left !leading-none">JOANNA KAWECKI</p>
					...
					<picture className="!basis-[35%] lg:!basis-[22.9%] order-1 md:order-2 mx-auto md:mx-0 mb-[35px] md:mb-0">
						<source srcSet="/photo/page/creative_with_refine/01/img/img-navigator.webp" type="image/webp" />
						<img src="/photo/page/creative_with_refine/01/img/img-navigator.jpg" alt="" className="w-[216px] md:w-auto" />
					</picture>
				</div>
			</section>
			...
			<section>
					...
					<div className="hidden md:block">
						<div className="flex-gap-40-2col">
							...
							<div className="grid gap-[40px] content-start">
								<picture>
									<source srcSet="/photo/page/creative_with_refine/01/img/img-hotel-1.webp" type="image/webp" />
									<img src="/photo/page/creative_with_refine/01/img/img-hotel-1.jpg" alt="" />
								</picture>
								<div>
									<picture>
										<source srcSet="/photo/page/creative_with_refine/01/img/img-hotel-2.webp" type="image/webp" />
										<img src="/photo/page/creative_with_refine/01/img/img-hotel-2.jpg" alt="" />
									</picture>
				...
				<section className="section">
					...
					<div className="hidden md:block">
						<picture>
							<source srcSet="/photo/page/creative_with_refine/01/img/img-hotel-3.webp" type="image/webp" />
							<img src="/photo/page/creative_with_refine/01/img/img-hotel-3.jpg" alt="" />
						</picture>
						<div className="flex">
				...
				<section className="section">
					...
					<div className="hidden md:block">
						...
						<div className="flex-gap-40-2col">
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-hotel-4.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-hotel-4.jpg" alt="" />
							</picture>
							<div>
								<picture>
									<source srcSet="/photo/page/creative_with_refine/01/img/img-hotel-5.webp" type="image/webp" />
									<img src="/photo/page/creative_with_refine/01/img/img-hotel-5.jpg" alt="" />
								</picture>
				...
				<section className="section md:flex-gap-40-2col">
					...
					<div>
						<picture>
							<source srcSet="/photo/page/creative_with_refine/01/img/img-hotel-6.webp" type="image/webp" />
							<img src="/photo/page/creative_with_refine/01/img/img-hotel-6.jpg" alt="" />
						</picture>
			...
			<section className="flex">
				...
				<div className="flex-1 min-w-0 border-t border-t-[var(--color-primary)]">
					...
					<section id="mens" className="fashion-content">
						...
						<div className="flex flex-col gap-[40px] lg:flex-gap-none-2col mb-[80px] lg:mb-0 lg:min-w-0">
							...
							<picture className="order-1 lg:order-2 lg:min-w-0">
								<source srcSet="/photo/page/creative_with_refine/01/img/img-mens-1.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-mens-1.jpg" alt="" />
							</picture>
						</div>
						{/* 02 */}
						<div className="flex flex-col gap-[40px] lg:flex-gap-none-2col mb-[80px] lg:mb-0">
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-mens-2.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-mens-2.jpg" alt="" />
							</picture>
						...
						<div className="flex flex-col gap-[40px] lg:flex-gap-none-2col">
							...
							<picture className="order-1 lg:order-2">
								<source srcSet="/photo/page/creative_with_refine/01/img/img-mens-3.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-mens-3.jpg" alt="" />
							</picture>
						</div>
					</section>
					{/* WOMENS */}
					<section id="womens" className="fashion-content">
						...
						<div className="flex flex-col gap-[40px] lg:flex-gap-none-2col mb-[80px] lg:mb-0">
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-womens-1.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-womens-1.jpg" alt="" />
							</picture>
							<div className="content-info-left">
						...
						<div className="flex flex-col gap-[40px] lg:flex-gap-none-2col mb-[80px] lg:mb-0">
							...
							<picture className="order-1 lg:order-2">
								<source srcSet="/photo/page/creative_with_refine/01/img/img-womens-2.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-womens-2.jpg" alt="" />
							</picture>
						</div>
						{/* 03 */}
						<div className="flex flex-col gap-[40px] lg:flex-gap-none-2col">
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-womens-3.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-womens-3.jpg" alt="" />
							</picture>
							<div className="content-info-left">
			...
			<section className="section-hotel">
				...
				<section className="hotel-content-box !pt-[44px] md:!pt-[43.5px]">
					...
					<div className="hidden md:block">
						<div className="flex-gap-1-3col mb-[37.5px]">
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-kyoto-1.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-kyoto-1.jpg" alt="" />
							</picture>
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-kyoto-2.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-kyoto-2.jpg" alt="" />
							</picture>
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-kyoto-3.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-kyoto-3.jpg" alt="" />
							</picture>
						</div>
					</div>
					{/* sp */}
				...
				<section className="hotel-content-box">
					...
					<div className="hidden md:block">
						<div className="flex-gap-1-3col">
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-numazu-1.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-numazu-1.jpg" alt="" />
							</picture>
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-numazu-2.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-numazu-2.jpg" alt="" />
							</picture>
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-numazu-3.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-numazu-3.jpg" alt="" />
							</picture>
						</div>
					</div>
					{/* sp */}
				...
				<section className="hotel-content-box">
					...
					<div className="hidden md:block">
						<div className="flex-gap-1-3col mb-[37.5px]">
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-satoyama-1.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-satoyama-1.jpg" alt="" />
							</picture>
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-satoyama-2.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-satoyama-2.jpg" alt="" />
							</picture>
							<picture>
								<source srcSet="/photo/page/creative_with_refine/01/img/img-satoyama-3.webp" type="image/webp" />
								<img src="/photo/page/creative_with_refine/01/img/img-satoyama-3.jpg" alt="" />
							</picture>
						</div>
					</div>
					{/* sp */}
